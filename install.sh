...
source $(dirname "$0")/util/install_oh_my_zsh.sh
source $(dirname "$0")/util/set_theme_and_plugins.sh
source $(dirname "$0")/util/uninstall_fpd_shell.sh
source $(dirname "$0")/util/print_success_message.sh
